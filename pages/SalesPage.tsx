  ...
  return (
    <div className="bg-[#FAF9F6] text-gray-900 min-h-screen font-sans pb-32 overflow-x-hidden selection:bg-[#FE2C55]/20">
      ...
      <section className="px-6 pt-16 pb-12 max-w-[1000px] mx-auto text-center animate-fade-in">
        ...
        <div className="relative flex justify-center items-center"><div className="absolute inset-0 bg-gradient-to-t from-[#FAF9F6] to-transparent z-10 h-32 bottom-0"></div><div className="relative group perspective"><div className="absolute -inset-4 bg-[#FE2C55]/5 rounded-[3rem] blur-2xl group-hover:bg-[#FE2C55]/10 transition-colors"></div><img src={ASSETS.PRODUTO_MOCKUP} alt="Material Filhos com Rotina" className="relative z-20 w-full max-w-[850px] drop-shadow-[0_50px_100px_rgba(0,0,0,0.12)] transform group-hover:scale-[1.02] transition-transform duration-700" /></div></div>
      </section>
